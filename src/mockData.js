  ...
  posts: [
    {
      ...
      user: "Ananya Sharma",
      campus: "IIT Bombay",
      content: "Just aced the McKinsey Sudoku challenge! 🧩 The pattern recognition skills really helped. Anyone else find the advanced levels tricky?",
      likes: 23,
      comments: ["Great job! I'm still stuck on level 3 😅", "Tips please! The timer stress is real"],
      timeAgo: "2h",
      anonymous: false
    },
    {
      ...
      user: "Anonymous",
      campus: "Anonymous",
      content: "Unpopular opinion: The Deloitte Your Way game actually taught me more about career planning than my college counselor 💀",
      likes: 45,
    ...
    },
    {
      ...
      user: "Priya Singh",
      campus: "BITS Pilani",
      content: "Quick meme break 😂 When you realize you've been playing NAukri games instead of studying for finals",
      likes: 67,
